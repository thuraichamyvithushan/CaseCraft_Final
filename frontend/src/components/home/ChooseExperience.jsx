          ...
          <div className="group relative bg-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-700">
            ...
            <div className="relative p-8 md:p-10 lg:p-16">
              ...
              <div className="w-24 h-24 bg-gradient-to-br from-[#FADC58] to-[#C79F2B] rounded-3xl flex items-center justify-center mb-10 shadow-2xl group-hover:scale-110 transition-transform duration-500">
                <QrCode className="w-10 h-10 text-[#124090]" />
              </div>

              <h3 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#124090] mb-6">
                Create Your Own<br />
                Custom Case
              </h3>
              ...
              <Link
                to="/case-design"
                className="group/btn inline-flex items-center gap-3 md:gap-5 bg-gradient-to-r from-[#FADC58] via-[#C79F2B] to-[#124090] text-white px-8 py-5 md:px-12 md:py-7 rounded-full text-lg md:text-2xl font-black shadow-2xl hover:shadow-[#FADC58]/60 hover:scale-110 transition-all duration-500"
              >
                Start Creating Now
          ...
          <div className="group relative bg-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-700">
            ...
            <div className="relative p-8 md:p-10 lg:p-16">
              ...
              <Link
                ...
                className="group/btn inline-flex items-center gap-3 md:gap-5 bg-gradient-to-r from-[#124090] via-[#C79F2B] to-[#FADC58] text-white px-8 py-5 md:px-12 md:py-7 rounded-full text-lg md:text-2xl font-black shadow-2xl hover:shadow-[#124090]/60 hover:scale-110 transition-all duration-500"
              >
                Start Your Business
                <ArrowRight className="w-6 h-6 group-hover/btn:translate-x-3 transition-transform duration-300" />
              </Link>
