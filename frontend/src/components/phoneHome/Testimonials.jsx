...
import phonecase10 from "../../assets/custom/phonecase9.png"
...
export default function Testimonials() {
  ...
  return (
<section className="relative py-12 sm:py-16 md:py-20 lg:py-24 bg-gray-100 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <h2 className="text-sm font-bold tracking-widest text-[#124090] uppercase mb-2">Community Love</h2>
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden min-h-[500px] md:min-h-[400px] flex flex-col md:flex-row transition-all duration-500">
          ...
          <div className="w-full md:w-2/5 relative h-64 md:h-auto">
            ...
            {/* Floating Icon */}
            <div className="absolute top-6 left-6 bg-white/90 backdrop-blur p-3 rounded-full shadow-lg text-yellow-500">
          ...
          <div className="w-full md:w-3/5 p-8 md:p-12 flex flex-col justify-center relative">
            ...
            <div className="flex items-center justify-between border-t border-gray-100 pt-6 mt-auto">
              <div>
                ...
                <span className="text-xs font-semibold text-[#124090] mt-1 block">
