    ...
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-white to-[#FDFBF7]">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-[#3065C5]/10 text-[#3065C5] px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider mb-4">
            <Sparkles className="w-4 h-4" />
            Common Questions
          </div>
          <h2 className="text-5xl md:text-6xl font-black text-[#124090] leading-tight">
            Got Questions?<br />
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className={`
                ...
                ${openIndex === index
                  ? 'bg-[#124090] text-white border-[#FADC58] shadow-2xl shadow-[#FADC58]/20'
                  : 'bg-white border-transparent hover:border-[#124090]/20 hover:shadow-xl'
                }
              `}
            >
              {/* Question */}
              <div className="px-8 py-6 flex justify-between items-center">
                <h3 className={`font-bold text-xl md:text-2xl transition-colors ${openIndex === index ? 'text-white' : 'text-[#124090] group-hover:text-[#3065C5]'
                  }`}>
                  {faq.question}
                </h3>
                <div className={`
                  ...
                  ${openIndex === index
                    ? 'bg-[#FADC58] text-[#124090] rotate-180'
                    : 'bg-[#124090]/10 text-[#124090] group-hover:bg-[#FADC58] group-hover:text-[#124090]'
                  }
                `}>
        ...
        <div className="mt-20 text-center">
          <p className="text-[#124090]/80 text-xl mb-6">
            Still unsure?
          </p>
          <Link to="/contact">
            <button
              className="
                group inline-flex items-center gap-2 bg-[#124090] text-white px-5 py-3              
                md:px-10 md:py-5 rounded-full text-base md:text-xl font-bold shadow-2xl
                hover:bg-[#FADC58] hover:text-[#124090] hover:scale-105 transition-all duration-300"
            >
