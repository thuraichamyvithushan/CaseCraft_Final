    ...
    <div className="min-h-screen pt-0 pb-6 md:pb-8 relative overflow-hidden" style={{
      ...
      <div className="relative z-10">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-center text-center">
            <div className="w-full">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-bold mb-2 leading-tight px-2">
                ...
                <br />
                <span className={`inline-block bg-gradient-to-r from-blue-400 via-purple-500 to-orange-400 bg-clip-text text-transparent transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95"
                  }`} style={{ transitionDelay: '400ms' }}>
                  ANSWERS
                </span>
              </h1>
              <p className={`text-xs sm:text-sm md:text-base lg:text-lg text-white/90 max-w-2xl mx-auto mt-4 sm:mt-6 leading-relaxed font-light transition-all duration-700 px-4 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
          {/* FAQ Image Section */}
          <div className={`mb-8 sm:mb-12 transition-all duration-1000 ease-out ${isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-10 scale-95"
            }`} style={{ transitionDelay: '200ms' }}>
          ...
          {/* Search Bar */}
          <div className={`mb-6 sm:mb-8 transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          ...
          {/* FAQ Questions */}
          <div className={`space-y-3 sm:space-y-4 transition-all duration-700 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            ...
            {filteredQuestions.map((item, index) => (
              ...
              >
                ...
                <div className={`overflow-hidden transition-all duration-700 ease-in-out ${openQuestion === item.id ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"
                  }`}>
                  <div className="px-4 sm:px-6 pb-4 sm:pb-6 pt-2 text-gray-600 border-t border-white/20 transition-all duration-500">
                    <div className={`transition-all duration-500 ${openQuestion === item.id ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2"
                      }`}>
                      {item.answer}
                    </div>
                  </div>
          ...
          {/* Chat Online CTA */}
          <div className={`mt-8 sm:mt-12 md:mt-16 text-center transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}>
