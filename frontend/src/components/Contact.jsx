        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 md:py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8 sm:mb-12">
            <a
              ...
              className={`relative backdrop-blur-xl bg-white/60 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/30 hover:bg-white/80 hover:border-[#FADC58] transition-all duration-500 hover:shadow-xl group transform hover:scale-[1.02] overflow-hidden ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
                }`}
            ...
            >
              ...
              <div className="flex items-center gap-2 sm:gap-3 relative z-10">
                ...
                <div>
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 group-hover:text-[#FADC58] transition-colors">Get a Machine For Your Site</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`relative backdrop-blur-xl bg-white/60 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/30 hover:bg-white/80 hover:border-[#fe7245] transition-all duration-500 hover:shadow-xl group transform hover:scale-[1.02] overflow-hidden ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"
                }`}
              style={{ transitionDelay: "200ms" }}
            >
              {/* Gradient accent */}
